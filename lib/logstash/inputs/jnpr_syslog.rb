...
#
# This pluging is originally Logstash/syslog input plugin, renamed to jnpr_syslog
# after modification. Changes are done to optimize syslog parsing of Juniper JUNOS 
# syslogs
#
# @author ahzam
#
...
# Original source code modified by Juniper Networks 25 Nov, 2015
# Changes made to adapt to Juniper Junos Device syslogs 
#      "overwrite" => "message",
#      "match" => { "message" => "<%{POSINT:priority}>%{SYSLOGLINE}" },
#      "tag_on_failure" => ["_grokparsefailure_sysloginput"],
#  
      "match" => { "message" => "%{JUNOS_STRUCT_HEADER} %{DATA:message_mod}]" },
      "tag_on_failure" => ["_not_junos"],
    )
# END of Change
