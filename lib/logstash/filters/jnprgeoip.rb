...
#
# Juniper Modified code, to disable debug logging in case the field being passed to resolve
# is not a valid ip field. 
class LogStash::Filters::GeoIP < LogStash::Filters::Base
  config_name "jnprgeoip"
  ...
  # Juniper Networks Change, new config added nologging
  ...
  config :target, :validate => :string, :default => 'jnprgeoip'
...
# Juniper Network change, use of config nologging
    if !nologging
